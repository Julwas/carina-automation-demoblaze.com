...
public class VNCTest implements IAbstractTest {
    ...
    public void vncTest() throws URISyntaxException {
        ...
        final WebsocketClientEndpoint clientEndPoint = new WebsocketClientEndpoint(new URI(EndpointUtils.getWebSocketUrl(getDriver(), "ws/vnc/")));
        ...
        Assert.assertTrue(EndpointUtils.isMessagePresent(wait, messages), "There are no messages from the VNC endpoint.");
